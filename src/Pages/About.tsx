    ...
    <div className="p-14 md:px-20 space-y-2">
        ...
        <div className="md:col-span-1 w-full h-auto">
          ...
          >
            <img
              src={im}
              alt=""
              className="object-cover rounded-full duration-1000 hover:scale-110 border-3 border-transparent bg-gradient-to-r from-orange-500 via-red-500 to-blue-500 p-1 shadow-md shadow-slate-500 hover:shadow-orange-500"
            />
          </motion.div>
        </div>
        <motion.div
      ...
      <div className="p-1 text-[13px] items-center justify-center col-span-3 w-full h-auto md:relative md:bottom-2">
        <motion.div
          ...
          animate={{ x: 0 }}
          transition={{ delay: 1, duration: 0.5 }}
          className="rounded-b-lg shadow-slate-500 shadow-md p-2 bg-orange-600 text-center text-white font-semibold"
        >
          <h1>
